...
void EnemyPatrolState::enterState(Entity* owner)
{
	...
	animate->setTag(EnemyStateMachine::EnemyAnimationTag);
	...
	auto _newEnemyPositionX = _owner->getModel()->getPositionX();
	auto _newEnemyPositionY = _owner->getModel()->getPositionY();
	...
	_owner->getModel()->runAction(repeatForever);
}
